...
require_relative 'lib/one_stack/aws/version'

Gem::Specification.new do |spec|
  spec.name          = 'onestack-aws'
  spec.version       = OneStack::Aws::VERSION
  spec.authors       = ['Robert Roach']
  spec.email         = ['rjayroach@gmail.com']

  spec.summary       = 'OneStack plugin for Amazon Web Services'
  spec.description   = 'OneStack plugin to create CNFS compatible blueprints for AWS'
